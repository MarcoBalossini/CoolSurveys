...
--
-- Host: 127.0.0.1    Database: cool_surveys
-- ------------------------------------------------------
...
CREATE TABLE `option` (
  ...
  CONSTRAINT `option/questionnaire` FOREIGN KEY (`questionaire_id`) REFERENCES `questionnaire` (`q_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-03-11 19:37:00
