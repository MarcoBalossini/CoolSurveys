...
INSERT INTO `bad_words` VALUES ('anus'),('arse'),('ass'),('bastard'),('bimbominkia'),('bitch'),('dick'),('dickhead'),('fuck'),('idiot'),('moron'),('shit'),('slut'),('vero'),('whore');
...
CREATE TABLE `credentials` (
  ...
  CONSTRAINT `credentials/user` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `submission` (
  ...
  CONSTRAINT `submission/user` FOREIGN KEY (`user`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-12-09 22:02:13
